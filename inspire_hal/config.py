...
QA_HAL_COL_IRI = 'https://api-preprod.archives-ouvertes.fr/sword/hal'
"""IRI used by the SWORD protocol when creating a new record on HAL.

Note:

    Use this to send records to their staging instance.
"""
...
Note:
    ...
    Use this to send records to their production instance.
"""

QA_HAL_EDIT_IRI = 'https://api-preprod.archives-ouvertes.fr/sword/'
"""IRI used by the SWORD protocol when updating an existing record on HAL.

Note:

    Use this to update records on their staging instance.
"""
...
Note:
    ...
    Use this to update records on their production instance.
"""
